        ...
        <v-card-text>
          <v-container>
            ...
            <v-row>
              ...
              <v-col cols="12" sm="6" md="6">
                <v-text-field label="ราคาสินค้า" v-model="form.unitprice" type="number"></v-text-field>
              </v-col>
              <v-col cols="12" sm="6" md="6">
                <!-- <v-text-field label="สถานะสินค้า" v-model="productstatus"></v-text-field> -->
                <v-select :items="status" label="สถานะสินค้า" v-model="form.productstatus"></v-select>
              </v-col>
              <v-col cols="12" sm="6" md="12">
                <v-textarea filled label="หมายเหตุสินค้า" v-model="form.notation"></v-textarea>
              </v-col>
              <!-- <v-col cols="12" sm="6" md="6">
                <v-select
